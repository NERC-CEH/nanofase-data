...
data_dict = du.parse_soil_texture_data(config['soil_texture_dir'], data_dict)

# Bulk density [g/cm3 = T/m3]
print('Parsing bulk density data...')
data_dict = du.parse_bulk_density_data(config['bulk_density'], data_dict)
...
data_dict = du.parse_cfactor_data(config['c-factor'], data_dict)

# USLE LS-factor. Resampled raster (from ESDAC dataset) from 100m to 5x5 km.
print('Parsing LS-factor data...')
data_dict = du.parse_lsfactor_data(config['ls-factor'], data_dict)
...
data_dict = du.parse_pfactor_data(config['p-factor'], data_dict)
